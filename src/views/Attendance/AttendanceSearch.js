    ...
    render() {
        ...
        return (
            <div>
                    ...
                    <GridItem xs={12} sm={12} md={12}>
                        ...
                        <div style={{ display: "inline", verticalAlign: "top", padding: "0 5px" }}>
                                ...
                                {this.state.data.attendances.length == 0 &&
                                    <div style={{ width: "100%" }}>
                                        <h4 style={{ textAlign: "center" }}>Nenhum atendimento encontrado.</h4>
                                        <span><ArrowDownwardIcon />Clique em <span style={{ fontWeight: "bold" }}>Novo atendimento</span> para criar um novo atendimento.</span>
                                    </div>}
                ...
                <Button color="success" onClick={e => this.props.history.push("/admin/attendances/create")}>Novo atendimento</Button>
...
export default connect(mapStateToProps)(
    withStyles(styles)(AttendanceSearch));