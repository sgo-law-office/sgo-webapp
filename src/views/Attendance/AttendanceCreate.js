...
class AttendanceDetails extends React.Component {
    ...
    searchCustomer(companyId) {
        ...
        if (this.state.customerSearch.query.code && this.state.customerSearch.query.code.trim().length > 0) {
        ...
        return (
            <div>
                ...
                <Dialog
                    ...
                    onClose={() => { this.setState({ customerSearch: { ...this.state.customerSearch, display: false } }) }}
                    aria-labelledby="alert-dialog-title"
                    aria-describedby="alert-dialog-description"
                >
                    <DialogTitle id="alert-dialog-title">Selecione um cliente</DialogTitle>
                    <DialogContent>
                                ...
                                <GridItem sm={12} md={4} lg={4}>
                                    <CustomInput
                                        ...
                                        inputProps={{
                                            placeholder: "Código",
                                            onKeyPress: e => { if (e.key === 'Enter') { this.searchCustomer(); } },
                                            onChange: e => this.setState({ customerSearch: { ...this.state.customerSearch, query: { ...this.state.customerSearch.query, code: e.target.value } } }),
                                            value: this.state.customerSearch.query.code
                                        }}
                                    />
                                </GridItem>
                    ...
                    <DialogActions>
                        <Button color="success" style={{ float: "left" }} onClick={() => { this.props.history.push("/admin/customers/create") }}>
                            Adicionar Cliente
                        </Button>
                        <Button color="transparent" autoFocus onClick={() => { this.setState({ customerSearch: { ...this.state.customerSearch, display: false } }) }}>
                            Cancelar
                        </Button>
                    </DialogActions>
                </Dialog>
                ...
                <div>
                    ...
                    <GridContainer>
                        ...
                        <GridItem xs={10} sm={9} md={8} lg={6}>
                            <CustomInput id="customer-search" labelText="Cliente"
